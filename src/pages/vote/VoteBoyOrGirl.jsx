...
function VoteBoyOrGirl() {
  return (
    <LayoutMain>
      ...
      <div className='mt-6 mx-8 p-4 w-5/6 md:w-[32rem] text-gray-500 text-lg font-medium text-center bg-white bg-opacity-25 rounded-lg' >
      ...
      <div className='mt-8 flex flex-col items-center w-full'>
        <div className='text-3xl text-gray-500 font-medium'>Marcador</div>
